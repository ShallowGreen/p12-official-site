...
const cloud = async function () {
  const cloud1 = await loadModel('https://medusa-test.oss-cn-hangzhou.aliyuncs.com/TEST/model/Cloud1.obj')
  ...
  const cloud2 = await loadModel('https://medusa-test.oss-cn-hangzhou.aliyuncs.com/TEST/model/Cloud2.obj')
  ...
  const cloud3 = await loadModel('https://medusa-test.oss-cn-hangzhou.aliyuncs.com/TEST/model/Cloud3.obj')
...
const deer = async function () {
  deerL = await loadModel('https://medusa-test.oss-cn-hangzhou.aliyuncs.com/TEST/model/deer.obj')
  console.log(deerL, 'deerL');
